...
@section('content')
    <div style="width:60%;margin-left:20%;">
        ...
        {!!Form::input('int','day',NULL,['class'=>'new_class input-xs','placeholder'=>'DD','size' => '1']) !!}
        {!!Form::input('int','month',NULL,['class'=>'new_class','placeholder'=>'MM','size' => '1']) !!}
        {!!Form::input('int','year',NULL,['class'=>'new_class input-xs','placeholder'=>'YYYY','size' => '3']) !!}<br>
        ...
        {!!Form::input('text','e_flock',NULL,['class'=>'new_class input-xs','placeholder'=>'New Flock Number'])!!}
