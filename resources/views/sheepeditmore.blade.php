...
@section('content')
    <div style="width:60%;margin-left:20%;">
        ...
        {!!Form::input('text','e_flock',$flock_old,['class'=>'new_class input-xs','placeholder'=>' New Flock Number'])!!}
        {!!Form::input('text','e_tag',sprintf('%05d',$e_tag),['class'=>'new_class input-xs','placeholder'=>' New Number'])!!}
        <br>
        {!! Form::label('text','New Numbers') !!}<br>
        {!!Form::label('text','UK 0')!!}
        {!!Form::input('text','e_flock',$flock_new,['class'=>'new_class input-xs','placeholder'=>' New Flock Number'])!!}
        {!!Form::input('text','e_tag',sprintf('%05d',$e_tag),['class'=>'new_class input-xs','placeholder'=>' New Number'])!!}
        <br>
